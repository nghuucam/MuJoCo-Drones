...
class DronePPOCurriculumEnv(BaseAviary):
    ...
    2. Cột trụ Gai xương rồng: Tăng gấp đôi số lượng vật cản (Level 1: 6, Level 2: 10, Level 3: 14) 
       và tăng gấp đôi số lượng gai trên mỗi cột (6 đến 12 gai).
    3. Tọa độ đích: Thu hẹp bán kính đích GOAL_THRESHOLD từ 2.0m xuống 1.0m (đòi hỏi đáp chuẩn xác).
