...
def compare_two_logs(file1, name1, file2, name2, window_size=50):
    """So sánh và vẽ biểu đồ phân tích giữa 2 file flight log CSV."""
    ...
    print("=" * 65)
    print(f"📊 BẢNG SO SÁNH HIỆU NĂNG HUẤN LUYỆN D3QN")
    print("=" * 65)
...
if __name__ == "__main__":
    ...
    FILE_1 = find_csv_file(base_dir, parent_dir, "drone_flight_log_test_D3QN.csv", "Single")
    NAME_1 = "D3QN Đơn lẻ (Single)"

    FILE_2 = find_csv_file(base_dir, parent_dir, "drone_flight_log_parallel_D3QN.csv", "Parallel")
    NAME_2 = "D3QN Song song (Parallel)"

    print(f"Đang tiến hành phân tích và so sánh 2 file:")
    print(f"1. {FILE_1}")
    print(f"2. {FILE_2}\n")
