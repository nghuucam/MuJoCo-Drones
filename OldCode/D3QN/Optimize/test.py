...
MODEL_PATH = r"C:\KLTN\MuJoCo-Drones\OldCode\D3QN\Optimize\Model\drone_model_optimize_d3qn_eposide100.pth"
...
def main():
    ...
    print("\n" + "=" * 65)
    print(f"📋 BÁO CÁO TỔNG KẾT KIỂM THỬ D3QN ({total} EPISODES)")
    print("=" * 65)
